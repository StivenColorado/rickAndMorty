...
btn.addEventListener('click', () => {
    ...
    let linkText = document.createTextNode('Location');
    a1.href = '../Pages/locations/Pages/locations.html';
    a1.appendChild(linkText);

    // Crear el contenido del enlace - episodios
    let linkText2 = document.createTextNode('Episode');
    a2.href = '../Pages/episode.html';
